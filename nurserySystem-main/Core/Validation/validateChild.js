...
exports.validateChildArray = [
  ...
  body('level')
    .isIn(['PreKG', 'KG1', 'KG2'])
    .withMessage('Child Level must be a String'),
  body('address').isObject().withMessage('Address must be an Object'),
  body('address.city')
    .isString()
    .withMessage('Child Address City must be a String'),
  body('address.street')
    .isString()
    .withMessage('Child Address Street must be a String'),
  body('address.building')
    .isInt()
    .withMessage('Child Address Building must be an Integer'),
];
...
exports.optValidateChildArray = [
  ...
  body('fullName')
    .optional()
    .isString()
    .withMessage('Child Full Name must be a String'),
  ...
  body('address.building')
    .optional()
    .isInt()
    .withMessage('Child Address Building must be a String'),
];
